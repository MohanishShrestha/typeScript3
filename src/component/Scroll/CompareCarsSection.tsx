...
import CompareAddModal from "./compareko/CompareAddModal";
...
export default function CompareCarsSection() {
  ...
  return (
    <Card className="p-4 md:p-6 m-6">
      <div className="flex justify-between"><h2 className="text-xl md:text-2xl font-semibold mb-4 text-gray-800">
      ...
      <div className="relative">
        <div ref={sliderRef} className="flex gap-6 overflow-x-auto pb-4">
          {selectedComparisons.map((c) => (
            <div key={c.id} className="min-w-[320px] border rounded-xl bg-white shadow">
              <div className="flex relative">
                <img src={c.image1} className="w-1/2 h-38 object-cover bg-gray-100" />
                <img src={c.image2} className="w-1/2 h-38 object-cover bg-gray-100" />
              ...
              <div className="p-4">
                ...
                <Button variant="outline" className="w-full mt-4 text-orange-600 border-orange-300">
                  {c.car1} vs {c.car2}
                </Button>
              </div>
            </div>
        ...
        <button
          onClick={scrollLeft}
          className="absolute left-2 top-1/2 -translate-y-1/2 bg-white shadow p-2 rounded-full hidden md:block"
        >
          <ChevronLeft size={18} />
        </button>
        ...
        <button
          onClick={scrollRight}
          className="absolute right-2 top-1/2 -translate-y-1/2 bg-white shadow p-2 rounded-full hidden md:block"
        >
       ...
       {/* Footer */}
      <div className="mt-4">
        <a href="#" className="text-orange-600 text-sm font-medium flex items-center">
